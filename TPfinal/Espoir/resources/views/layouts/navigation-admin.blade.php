        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-6 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.dashboard')" :active="request()->routeIs('admin.dashboard')" class="text-amber-50 hover:text-white hover:border-amber-100">
                        {{ __('Tableau de bord') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.pending.users')" :active="request()->routeIs('admin.pending.users')" class="text-amber-50 hover:text-white hover:border-amber-100">
                        {{ __('Entrepreneurs en attente') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.commandes.index')" :active="request()->routeIs('admin.commandes.*')" class="text-amber-50 hover:text-white hover:border-amber-100">
                        {{ __('Commandes') }}
                    </x-nav-link>
                </div>
            </div>
